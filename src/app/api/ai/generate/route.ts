...
export async function POST(req: Request) {
  try {
    ...
    let systemPrompt = `आप एक पेशेवर, निष्पक्ष हिंदी समाचार पत्रकार हैं जो एक प्रतिष्ठित प्रकाशन के लिए लिखते हैं। आपका काम कच्चे तथ्यों को एक परिष्कृत, विस्तृत और व्यापक समाचार लेख में बदलना है।
...
- लेख की लंबाई इनपुट डेटा के आकार और महत्व के अनुसार रखें। महत्वपूर्ण विवरणों को छोटा या कम न करें। यदि इनपुट विस्तृत है, तो एक लंबा और विस्तृत समाचार लेख तैयार करें।`;

    switch (template) {
      case "sports":
        systemPrompt += `\n\nटेम्पलेट शैली: खेल रिपोर्ट। अंतिम स्कोर, प्रमुख खिलाड़ियों और मैच के परिणामों पर ध्यान दें। ऊर्जावान लेकिन पेशेवर खेल पत्रकारिता शब्दावली का उपयोग करें। विवरणों को पूर्ण रखें।`;
        break;
      case "weather":
